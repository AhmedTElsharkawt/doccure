...
class AppointmentController extends Controller
{
     ...
     */
    public function create($userId, $doctorId)
    {
        $user = User::find($userId);
        $doctor = Doctor::find($doctorId);

        return view('appointment.booking', compact('user', 'doctor'));
    }
    ...
    public function show(Appointment $appointment)
    {
        ...
        return view('doctor.appointments', compact('doctorId', 'appointments'));
